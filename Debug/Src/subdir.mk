...
C_SRCS += \
../Src/stm32_usart_test.c \
../Src/syscalls.c \
../Src/sysmem.c 

OBJS += \
./Src/stm32_usart_test.o \
./Src/syscalls.o \
./Src/sysmem.o 

C_DEPS += \
./Src/stm32_usart_test.d \
./Src/syscalls.d \
./Src/sysmem.d 
...
Src/stm32_usart_test.o: ../Src/stm32_usart_test.c
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DSTM32 -DSTM32F407G_DISC1 -DSTM32F4 -DSTM32F407VGTx -DDEBUG -c -I../Inc -I"/Users/neilpatel/STM32CubeIDE/workspace_1.2.0/stm32f4xx_drivers/drivers/inc" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Src/stm32_usart_test.d" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@"
